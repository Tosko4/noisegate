...
- Harden `reduce-json` host-adapter handling for mixed direct/envelope terminal payloads, metadata key collisions, command aliases, and positional terminal-hook calls.
